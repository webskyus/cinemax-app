...
export const StarIcon = component$(({
    ...
    return (
        <svg width={width}
            ...
            <rect width="512" height="512" x="0" y="0" rx="41" fill="transparent" stroke="#B43FEB" stroke-width="0"
                  stroke-opacity="100%" paint-order="stroke"></rect>
            <svg width="512px" height="512px" viewBox="0 0 48 48" fill="#E4AB00" x="0" y="0" role="img"
