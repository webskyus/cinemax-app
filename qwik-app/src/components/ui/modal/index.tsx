            ...
            isVisible
                    ? <div id="defaultModal" tab-index="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                        <div class="relative mx-[auto] my-[0] mt-[108px] w-full h-full max-w-4xl md:h-auto">
                            <div class="relative bg-white rounded-[6px] bg-grayscale-10 dark:bg-additional-dark-smooth shadow-xl">
                                <div class="flex items-start justify-between p-4 border-b-[4px] border-primary">
                                ...
                                <div class={`flex justify-center items-center h-[500px] bg-grayscale-10 dark:bg-additional-dark-smooth`}>
                                    <span class={`absolute w-8 h-8 inline-block animate-spin rounded-full border-4 border-solid border-primary border-r-transparent motion-reduce:animate-[spin_1.5s_linear_infinite]`} />
                                    <iframe width="100%"
                                            height="100%"
